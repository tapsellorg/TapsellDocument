...
> **خطای مورد نظر شما در این صفحه مطرح نشده است؟** در [قسمت Issues گیت‌هاب](https://github.com/irancell/YelloadwiseSDK-FlutterPlugin/issues?q=is%3Aissue) جستجو کنید و در صورت نیافتن در آنجا [مورد جدیدی](https://github.com/irancell/YelloadwiseSDK-FlutterPlugin/issues/new/choose) مطرح کنید.
...
> توصیه می‌شود که به نسخه‌ی ۲.۱.۶ بروزرسانی کنید و با کد `Yelloadwise.instance.setDebugMode(LogLevel.Verbose)` اطلاعات بیشتری در مورد خطا کسب کنید
