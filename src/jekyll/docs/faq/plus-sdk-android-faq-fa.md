...
> **خطای مورد نظر شما در این صفحه مطرح نشده است؟** در [قسمت Issues گیت‌هاب](https://github.com/irancell/YelloadwiseSDK-AndroidSample/issues?q=is%3Aissue) جستجو کنید و در صورت نیافتن در آنجا [مورد جدیدی](https://github.com/irancell/YelloadwiseSDK-AndroidSample/issues/new/choose) مطرح کنید.
...
### خطای Yelloadwise Plus is not Initialized
...
> توصیه می‌شود که به نسخه‌ی ۲.۱.۶ بروزرسانی کنید و با کد `Yelloadwise.setDebugMode(Log.DEBUG)` اطلاعات بیشتری در مورد خطا کسب کنید
