...
در این بخش خطاهایی که ممکن‌ است در مراحل مختلف راه‌اندازی یلوادوایز در React Native با آن‌ها مواجه شوید به همراه راه‌ حل ذکر شده‌اند.

> **خطای مورد نظر شما در این صفحه مطرح نشده است؟** در [قسمت Issues گیت‌هاب](https://github.com/irancell/YelloadwiseSDK-ReactNativePlugin/issues?q=is%3Aissue) جستجو کنید و در صورت نیافتن در آنجا [مورد جدیدی](https://github.com/irancell/YelloadwiseSDK-ReactNativePlugin/issues/new/choose) مطرح کنید.
{:data-title="نکته" data-color="red"}

### npm ERR! peer react-native@"0.63.4" from react-native-irancell.ir-plus

در صورتیکه با این خطا مواجه شدید، از دستور زیر در هنگام نصب پکیج یلوادوایز‌پلاس استفاده نمایید:

`npm i --legacy-peer-deps react-native-irancell.ir-plus --save`
