...
خیر، مبلغی که شما در پنل خود شارژ می‌کنید، تنها برای کمپین‌های تبلیغاتی‌ قابل استفاده است و امکان بازگشت وجه وجود ندارد. لطفا در هنگام شارژ اکانت دقت کنید.
