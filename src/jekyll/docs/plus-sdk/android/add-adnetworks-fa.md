...
>
> برای اضافه کردن App ID ابتدا از یکی از راه‌های زیر این شناسه را از یلوادوایز دریافت کنید (پیش از دریافت شناسه، شرایط فعال‌سازی شبکه‌های تبلیغاتی خارجی را در [این لینک](https://irancell.ir/Yelloadwise/) مطالعه نمایید):
...
|:-------------------:|:---------------:|:------------------------:|:----------------------------:|
| 2.1.9-rc03 - 2.2.0  |      21.5.0     |          Q1 2024         |            Q2 2025           |
