...
- از نسخه 1.2.3-rc4  در صورتی که از layout ‌پیش فرض استفاده نمیکنید و خودتان layoutای را طراحی و پیاده‌سازی نموده‌اید، لطفا به جای com.google.android.gms.ads.formats.MediaView از ir.tapsell.plus.imp.admob.AdMobMediaView استفاده نمایید.
