...
>
> برای اضافه کردن App ID ابتدا از یکی از راه‌های زیر این شناسه را از یلوادوایز دریافت کنید (پیش از دریافت شناسه، شرایط فعال‌سازی شبکه‌های تبلیغاتی خارجی را در [این لینک](https://yelloadwise.ir/Yelloadwise/) مطالعه نمایید):
> - ارسال ایمیل به `publishers [at] yelloadwise`
> - ارسال تیکت به [دپارتمان ناشرین](https://yelloadwise.deskpro.com/new-ticket)
...
|  **نسخه‌ی یلوادوایز‌پلاس** | **نسخه‌ی ادموب** | **تاریخ اتمام پشتیبانی** | **تاریخ اتمام دریافت تبلیغ** |
|:-------------------:|:---------------:|:------------------------:|:----------------------------:|
...
نسخه‌های یلوادوایز قدیمی‌تر از ۱.۲.۶ را حتما به نسخه‌های جدیدتر آپدیت نمایید.
