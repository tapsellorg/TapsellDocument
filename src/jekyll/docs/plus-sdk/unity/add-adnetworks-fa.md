...
## افزودن شبکه های تبلیغاتی در یلوادوایز ۲.۱.۸ به بالا
### اضافه کردن ادموب
...
۱. فایل `Assets\Yelloadwise\Editor\YelloadwiseDependencies.xml` را باز کنید و ادنتورک مد نظر خود را مطابق زیر اضافه کنید
 ```xml
    <dependencies>
      <androidPackages>
...
## افزودن شبکه های تبلیغاتی در یلوادوایز ۲.۱.۷ به پایین
...
## تنظیمات Resolver
هر شبکه‌ی تبلیغاتی که مایل هستید را مطابق الگوی زیر در آدرس `Assets\Yelloadwise\Editor\YelloadwiseDependencies.xml` قرار دهید.
