...
۳. ابتدا `unitypackage` تپسل پلاس را از [این لینک](https://github.com/tapsellorg/TapsellPlusSDK-UnityPlugin/releases/download/v2.2.4/tapsell-plus-unity-2.2.4.unitypackage) دریافت نمایید. 
