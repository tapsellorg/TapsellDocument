...
۳. ابتدا `unitypackage` تپسل پلاس را از [این لینک](https://github.com/tapsellorg/TapsellPlusSDK-UnityPlugin/releases/download/v2.2.1/tapsell-plus-unity-2.2.1.unitypackage) دریافت نمایید. 
