...
* [دریافت فایل برای روش Gradle مربوط به توزیع یونیتی ۲۰۱۹](https://github.com/tapsellorg/TapsellPlusSDK-UnitySample2019/releases/download/v2.5/TapsellPlusUnity2019Gradle-v2.5.unitypackage)
...
* [دریافت فایل برای روش Resolver مربوط به توزیع یونیتی ۲۰۱۹](https://github.com/tapsellorg/TapsellPlusSDK-UnitySample2019/releases/download/v2.5/TapsellPlusUnity2019EDM-v2.5.unitypackage)
...
unityPackage مربوط به Gradle تپسل پلاس را import کنید.
