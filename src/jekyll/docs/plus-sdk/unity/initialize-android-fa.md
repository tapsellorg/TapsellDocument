...
## مقداردهی اولیه
ابتدا برای دسترسی به کدهای تپسل از namespace TapsellPlus استفاده کنید یا پیش از هر کدام از دستوراتی که در این مستندات می‌آید، عبارت TapsellPlus را اضافه نمایید.
