...
lang: fa
permalink: /yelloadwise-core/reactnative/initialize-android/index.html
...
```console
npm install react-native-yelloadwise --save
```


## شروع کار با SDK یلوادوایز
ابتدا ماژول یلوادوایز را به کد خود اضافه کنید:

```javascript
import Yelloadwise from 'react-native-yelloadwise'
```
...
`YELLOADWISE_KEY` کلید یلوادوایز هست و برای هر اپلیکیشن که میسازید در [پنل یلوادوایز](https://dashboard.yelloadwise.ir/) ساخته میشود، میتوانید از پنل کپی کنید.
