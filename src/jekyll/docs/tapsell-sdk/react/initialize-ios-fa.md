---
layout: classic-docs
title: راه اندازی یلوادوایز در ReactNative (iOS)
lang: fa
permalink: /yelloadwise-core/reactnative/initialize-ios/index.html
...
[دریافت فایل](https://storage.backtory.com/yelloadwise-server/sdk/LatestVersions/iOsYelloadwiseSdk.zip)
...
**دقت کنید که از هر نسخه‌ای که استفاده می‌کنید ، نام فایل فریمورک را به `YelloadwiseSDKv3.framework` تغییر دهید.**
