...
- اضافه شدن تبلیغات `Pre-Roll` مربوط به `Google IMA` در کتابخانه یلوادوایز با پشتیبانی از `VideoPlayer` و `ExoPlayer`. [لینک سمپل](https://github.com/irancell/YelloadwiseSDK-AndroidSample/blob/master/app/src/main/java/ir/irancell.ir/plussample/android/ExoPlayerVastActivity.java)
...
- به‌روز‌رسانی کتابخانه یلوادوایز به نسخه `4.7.8-rc03`
- رفع بعضی از `Memory Leak` های گزارش شده توسط کاربران. [لینک گیتهاب](https://github.com/irancell/YelloadwiseSDK-AndroidSample/issues/58)
...
#### Flutter
- افزودن امکان نمایش تبلیغات نیتیو بنری ادموب در پلاگین فلاتر. برای اطلاعات بیشتر به مستندات [نیتیو فلاتر](https://docs.irancell.ir/plus-sdk/flutter/native/) مراجه کنید

### v2.1.7 - 2022/03/28
- بروزرسانی AdMob به `20.6.0` و رفع [#41](https://github.com/irancell/YelloadwiseSDK-AndroidSample/issues/41)
- Minor bug fixes
...
### v2.1.3 - 2021/07/21
* استفاده از نسخه 4.7.2 یلوادوایز
* اضافه‌شدن قابلیت نمایش تبلیغ [**NativeVideo**](/plus-sdk/android/native-vid/index.html) یلوادوایز
* اضافه شدن قابلیت نمایش **Pre-roll ad**
  - اضافه‌شدن متد `Yelloadwise.getVastTag`
...
* استفاده از کلاس YelloadwiseAdModel به جای String در آرگومان ورودی کالبک response در درخواست تبلیغ (مستندات مربوط به هر نوع تبلیغ مطالعه شود)
...
* [حذف دسترسی PHONE_STATE](https://docs.irancell.ir/plus-sdk/android/initialize/#%D8%AF%D8%B3%D8%AA%D8%B1%D8%B3%DB%8C%D9%87%D8%A7)
* [پشتیبانی از یلوادوایز نسخه‌ی ۴.۷.۰](https://docs.irancell.ir/yelloadwise-core/android/main/#v470---20210510)
...
* [تغییر کلاس rootView در تبلیغ همسان به com.google.android.gms.ads.nativead.NativeAdView](https://docs.irancell.ir/plus-sdk/android/native/#%D8%B3%D8%A7%D8%AE%D8%AA-adholder)
* [تغییر کلاس media view در تبلیغ همسان به ir.yelloadwise.adNetworks.admob.AdMobMediaView](https://docs.irancell.ir/plus-sdk/android/native/#%D8%B3%D8%A7%D8%AE%D8%AA-adholder)

### v1.2.6 - 2021/05/04
* [تغییر محل انتشار نسخه‌ها از Bintray به MavenCentral](https://docs.irancell.ir/plus-sdk/android/initialize/#%D8%AA%D9%86%D8%B8%DB%8C%D9%85%D8%A7%D8%AA-gradle)
* تغییر نسخه‌ی AdColony به ۴.۵.۰
* [نغییر در محل انتشار شبکه‌های تبلیغاتی AdColony و Chartboost به mavenCentral](https://docs.irancell.ir/plus-sdk/android/add-adnetworks/#%D8%AA%D9%86%D8%B8%DB%8C%D9%85%D8%A7%D8%AA-gradle)

### v1.2.3-rc4 - 2021/1/02
* مطابقت با اندروید 11
* استفاده از نسخه rc5-4.6.3 یلوادوایز
* [تغییر جزئی در استفاده از بنر همسان](https://docs.irancell.ir/plus-sdk/android/native/#%D8%B3%D8%A7%D8%AE%D8%AA-adholder)

### v1.2.2 - 2020/12/07
* رفع برخی مشکلات مربوط به GDPR
* استفاده از نسخه 4.6.2 یلوادوایز

### v1.2.1 - 2020/11/22
* رفع برخی مشکلات
* استفاده از نسخه 4.6.0 یلوادوایز
* افزودن قابلیت نمایش تبلیغ همسان AdMob

### v1.1.3 - 2020/8/11
* رفع برخی مشکلات
* استفاده از نسخه 4.5.0 یلوادوایز
