## Yelloadwise Unity Changelog

### v2.2.0 - 2023/06/23
- Fixed Google Play policy error related to Collecting user's installed apps. [Issue #68](https://github.com/irancell/YelloadwiseSDK-AndroidSample/issues/68)
- Added new UI for back dialog
- Added support for Unity Editor before 2020
- Update android yelloadwise dependency to `2.2.0`
- Update Google Mobile Ads to `8.3.0`. (Android gradle dependency to `22.1.0`)
- Fixed some memory leaks in yelloadwise sdk and Yelloadwise sdk
- Fixed some proguard issues

### v2.1.8 - 2022/12/07
* Added new Yelloadwise Unity package to integrate both Gradle & Resolver methods for implementation of yelloadwise package.
  - Refer to [package download link](https://github.com/irancell/YelloadwiseSDK-UnityPlugin/releases) or [Github repository](https://github.com/irancell/YelloadwiseSDK-UnityPlugin) for more information.
...
* Fixed reported GitHub issue [#9](https://github.com/irancell/YelloadwiseSDK-UnitySample2019/issues/9)

### v2.1.7 - 2022/04/04
* [Using Yelloadwise version 2.1.7](/plus-sdk/android/main/#v217---20220328)
* Update AdMob to `20.6.0` and AppSetId to 16.0.2 which fixes [#41](https://github.com/irancell/YelloadwiseSDK-AndroidSample/issues/41)
* Fix `SSL Exception` prior to Android 4.4
* Minor bug fixes

### v2.1.6 - 2022/01/12
* Using the yelloadwise version 4.7.4
...
* Added support for Mintegral ** 15.6.11 **
  ...
  * Added Ability to display GDPR dialog at any time by Developer
  - Added the method `Yelloadwise.showGDPRDialog(activity)` to display the dialog
...
### v2.1.3 - 2021/07/21
* [Using Yelloadwise version 2.1.3](/plus-sdk/android/main/#v213---20210721)
...
### v2.1.2 - 2021/06/08
> ** NOTE ** From this version onwards, the version number of Yelloadwise Unity Plugin will be in accordance with the version number of Yelloadwise Android SDK. Therefore, the current version 2.1.2 is newer than the previous version 2.5


* [Using TepselPlus version 2.1.2](https://docs.yelloadwise/plus-sdk/android/main/#v212---20210607)
