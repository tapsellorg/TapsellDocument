...
const siteConfig = {
  ...
  projectName: 'TapsellDocument',
  organizationName: 'tapsellorg',
  ...
  headerLinks: [
    {doc: 'android_initialize', label: 'مستندات'},
    // {doc: 'doc4', label: 'API'},
  ...
  */
  ...
  scripts: [
    ...
    '/TapsellDocument/js/code-blocks-buttons.js',
  ],
